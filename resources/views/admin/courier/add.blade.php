                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('courier.store')}}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="firstName" placeholder="Courier Name" type="text" name="name"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="" class="col-md-3 form-label">Courier Email</label>
                            <div class="col-md-9">
                                <input class="form-control" id="" placeholder="Courier Email" type="email" name="email"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="" class="col-md-3 form-label">Courier Mobile</label>
                            <div class="col-md-9">
                                <input class="form-control" id="" placeholder="Courier Email" type="number" name="mobile"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="" class="col-md-3 form-label">Courier Cost</label>
                            <div class="col-md-9">
                                <input class="form-control" id="" placeholder="Courier Cost" type="number" name="cost"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Courier Address</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="lastName" name="address" placeholder="Courier Address"></textarea>
                            </div>
                        </div>
