                    ...
                    div += '<div class="container">';
                        div += '<div class="row">';
                            div += '<div class="col-12">';
                                div += '<h2 class="text-center">Search Result</h2>';
                            div += '</div>';
                        div += '</div>';
                        div += '<div class="row">';
                                ...
                                div += '<div class="col-lg-3 col-md-6 col-12">';
                                    div += '<div class="single-product">';
                                        div += '<div class="product-image">';
                                            div += '<img src="'+value.image+'" alt="#" height="250"/>';
                                        div += '</div>';
                                        div += '<div class="product-info">';
                                            div += '<h4 class="title"><a href="http://localhost/ecom-batch9/public/product-detail/'+value.id+'"> '+value.name+' </a></h4>';
                                            div += '<ul class="review">';
                                                div += '<li><i class="lni lni-star-filled"></i></li>';
                                                div += '<li><i class="lni lni-star-filled"></i></li>';
                                                div += '<li><i class="lni lni-star-filled"></i></li>';
                                            div += '</ul>';
                                            div += '<div class="price">';
