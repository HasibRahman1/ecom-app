                        ...
                        <form class="row" action="{{route('customer-register')}}" method="post">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="email" placeholder="Email Address"  id="reg-email" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="reg-phone">Mobile Number</label>
                                    <input class="form-control" type="number" name="mobile" placeholder="Mobile Number" id="reg-phone" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="reg-pass">Password</label>
                                    <input class="form-control" type="password" name="password" placeholder="Password" id="reg-pass" required>
                                </div>
                            </div>
                            <div class="button">
